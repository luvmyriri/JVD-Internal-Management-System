...
class StoreInvoiceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'items.*.item_metadata.is_fixed_rate' => 'nullable|boolean',
            'items.*.item_metadata.includes_driver' => 'nullable|boolean',
            ...
            'items.*.item_metadata.bus_assignments.*.driver_id' => 'nullable|integer|exists:users,id',
            'items.*.item_metadata.bus_assignments.*.unit_number' => 'nullable|integer',
            'items.*.item_metadata.bus_assignments.*.plate_number' => 'nullable|string|max:100',
            'items.*.item_metadata.bus_assignments.*.model' => 'nullable|string|max:100',
            'items.*.item_metadata.bus_assignments.*.seating_capacity' => 'nullable|integer',
            'items.*.item_metadata.bus_assignments.*.driver_name' => 'nullable|string|max:255',
            'items.*.item_metadata.bus_assignments.*.driver_phone' => 'nullable|string|max:50',
            'items.*.item_metadata.fleet_assignments' => 'nullable|array|max:100',
            'items.*.item_metadata.fleet_assignments.*.unit_number' => 'nullable|integer',
            'items.*.item_metadata.fleet_assignments.*.bus_id' => 'nullable|integer',
            'items.*.item_metadata.fleet_assignments.*.driver_id' => 'nullable|integer',
            'items.*.item_metadata.fleet_assignments.*.plate_number' => 'nullable|string|max:100',
            'items.*.item_metadata.fleet_assignments.*.model' => 'nullable|string|max:100',
            'items.*.item_metadata.fleet_assignments.*.seating_capacity' => 'nullable|integer',
            'items.*.item_metadata.fleet_assignments.*.driver_name' => 'nullable|string|max:255',
            'items.*.item_metadata.fleet_assignments.*.driver_phone' => 'nullable|string|max:50',
