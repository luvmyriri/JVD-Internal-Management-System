...
class UpdateServiceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'package_config.pickup_coords' => 'nullable|array',
            'package_config.pickup_coords.*' => 'nullable|numeric',
            'package_config.dropoff_coords' => 'nullable|array',
            'package_config.dropoff_coords.*' => 'nullable|numeric',
            ...
            'package_config.route_distance_km' => 'nullable|numeric|min:0|max:100000',
            'package_config.estimated_diesel_liters' => 'nullable|numeric|min:0|max:100000',
            'package_config.estimated_diesel_cost' => 'nullable|numeric|min:0|max:100000000',
            ...
            'package_config.days' => 'nullable|array',
            'package_config.days.*.day_number' => 'nullable|integer',
            'package_config.days.*.date' => 'nullable|string',
            'package_config.days.*.location' => 'nullable|string',
            'package_config.days.*.activity_description' => 'nullable|string',
            'package_config.days.*.meal_plan' => 'nullable|string',
            'package_config.days.*.accommodation_name' => 'nullable|string',
