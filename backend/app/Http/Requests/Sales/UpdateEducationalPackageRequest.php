...
class UpdateEducationalPackageRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'tour_code' => ['nullable', 'string', 'max:40', "unique:educational_tour_packages,tour_code,{$packageId}"],
            'name' => ['sometimes', 'required', 'string', 'max:180'],
            'school_name' => ['sometimes', 'required', 'string', 'max:180'],
            ...
            'maximum_capacity' => ['sometimes', 'required', 'integer', 'min:1', 'max:10000'],
            'rate_per_head' => ['sometimes', 'required', 'numeric', 'min:0'],
