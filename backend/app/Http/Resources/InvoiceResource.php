...
class InvoiceResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'travel_date' => $this->booking?->travel_date ? $this->booking->travel_date->format('Y-m-d') : null,
            'pickup_location' => $this->booking?->pickup_location,
            'tour_code' => $this->booking?->tour_code,
            'pax_count' => $this->booking?->pax_count,
            'driver' => ($this->relationLoaded('booking') && $this->booking && $this->booking->relationLoaded('driver') && $this->booking->driver) ? [
