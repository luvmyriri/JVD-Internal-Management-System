    ...
    public function run(): void
    {
        $employees = [
            [
                ...
                'first_name' => 'Minda',
                'last_name' => 'Lamsen',
                'email' => 'johnemmanuelnalang+emp1@gmail.com',
            ...
            [
                ...
                'first_name' => 'Jaymart',
                'last_name' => 'Lamsen',
                'email' => 'johnemmanuelnalang+emp2@gmail.com',
                'password' => \Hash::make('password123'),
                'role' => 'accounting',
            ...
            [
                ...
                'first_name' => 'John',
                'last_name' => 'Mechanic',
                'email' => 'johnemmanuelnalang+emp3@gmail.com',
                'password' => \Hash::make('password123'),
                'role' => 'agent',
            ...
            [
                ...
                'first_name' => 'Driver',
                'last_name' => 'One',
                'email' => 'johnemmanuelnalang+emp4@gmail.com',
                'password' => \Hash::make('password123'),
                'role' => 'agent',
                'department' => 'Operations',
                'is_active' => true,
            ...
            [
                ...
                'first_name' => 'Sarah',
                'last_name' => 'HR',
                'email' => 'johnemmanuelnalang+emp5@gmail.com',
                'password' => \Hash::make('password123'),
                'role' => 'human_resource',
