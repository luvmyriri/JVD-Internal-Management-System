...
<head>
    ...
    <title>Booking Confirmed — {{ $invoice->invoice_number }}</title>
</head>
                ...
                <table width="600" border="0" cellspacing="0" cellpadding="0" style="background-color: #ffffff; border: 1px solid #e5e7eb; border-radius: 20px; overflow: hidden; box-shadow: 0 10px 25px -5px rgba(0, 0, 0, 0.05), 0 8px 10px -6px rgba(0, 0, 0, 0.01);">
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <h2 style="margin: 0 0 24px 0; font-size: 20px; font-weight: 800; color: #111827; letter-spacing: -0.5px; line-height: 1.3;">Your Booking is Confirmed!</h2>

                            <p style="font-size: 15px; line-height: 1.6; color: #4b5563; margin: 0 0 20px 0;">
                                Hello <strong style="color: #111827;">{{ $invoice->customer_name }}</strong>,
                            </p>

                            <p style="font-size: 15px; line-height: 1.6; color: #4b5563; margin: 0 0 25px 0;">
                                Thank you for booking with JVD Event &amp; Travel Management Company. Your contract has been signed and your booking is now confirmed. Here's a summary of your booking:
                            </p>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="16" style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 12px; margin-bottom: 30px;">
                                <tr>
                                    <td width="50%" style="font-size: 13px; color: #4b5563; line-height: 1.5; border-right: 1px solid #e5e7eb;">
                                        <span style="font-size: 10px; font-weight: 800; color: #9ca3af; text-transform: uppercase; letter-spacing: 0.5px;">Invoice No.</span><br>
                            ...
                            @if($contract)
                            <p style="font-size: 13px; line-height: 1.6; color: #6b7280; margin: 0 0 20px 0;">
                                A copy of your signed contract (#{{ $contract->contract_number }}) is attached to this email for your records.
                            </p>
                            @endif
