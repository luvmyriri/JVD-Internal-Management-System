...
export default function Dashboard() {
  ...
  const exportToExcel = (title: string, data: any[]) => {
    ...
    // Add the professional header at the top
    const heading = [
      [`JVD INTERNAL MANAGEMENT SYSTEM - ${title.toUpperCase()}`],
    ...
    // Add the data starting from row 5 (A5)
    XLSX.utils.sheet_add_json(ws, data, { origin: 'A5' });

    // Auto-size columns (basic width)
