  ...
  return (
    <div className="flex flex-col gap-2 pb-4 lg:h-[calc(100vh-9.5rem)] lg:overflow-y-auto custom-scrollbar">
      ...
      {isApprover && pendingBudgets.length > 0 && (
        <div className="bg-surface border border-border rounded-[2rem] p-6 shadow-sm flex flex-col gap-4 animate-in fade-in slide-in-from-top-4 duration-500 shrink-0">
              ...
              return (
                ...
                >
                  <div>
                    ...
                    {budget.plate_number && (
                      <p className="text-[7.5px] text-muted font-medium mt-0.5">
                  ...
                  <div className="flex gap-2 shrink-0">
                    ...
                    <button
                      ...
                      className="py-1.5 px-3 bg-surface-elevated hover:bg-gray-200 dark:hover:bg-gray-700 text-muted rounded-xl text-[8px] font-black uppercase tracking-wider transition-all"
                    >
                      Decline
                    </button>
                  </div>
