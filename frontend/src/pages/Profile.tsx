    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm text-center">
        ...
        <div className="md:col-span-2 space-y-6">
          <form onSubmit={handleUpdateProfile} className="bg-white dark:bg-gray-800 p-8 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm space-y-6">
            <div className="flex items-center justify-between mb-2">
              ...
              {!isEditing && (
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-slate-50 dark:bg-gray-800 border border-slate-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 text-xs font-bold rounded-xl hover:bg-white dark:bg-gray-900 dark:hover:bg-gray-700 transition shadow-sm"
                >
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-gray-700 dark:text-gray-400 uppercase tracking-wider flex items-center gap-2">
                <LuPhone className="w-3 h-3 text-blue-600" />
              ...
              <input
                ...
                disabled={!isEditing}
                className={`w-full px-4 py-2.5 rounded-xl border outline-none transition ${isEditing ? 'bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:text-white' : 'bg-gray-50 dark:bg-gray-800/50 border-gray-100 dark:border-gray-800 text-gray-500 dark:text-gray-600 cursor-not-allowed'}`}
            ...
            {isEditing && (
              <div className="pt-4 flex justify-end gap-3">
                <button
                  ...
                  className="px-6 py-2.5 text-gray-600 dark:text-gray-300 text-sm font-bold rounded-xl hover:bg-gray-100 transition"
                >
                  Cancel
                </button>
                <button
              ...
              <>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Please enter your current and new password.</p>
                  </div>
                </div>
                ...
                <form onSubmit={handleChangePassword} className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      <input
                        ...
                        className="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-800/60 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition pr-12"
                  ...
                  <div className="p-4 bg-gray-50 dark:bg-gray-800/60 rounded-xl border border-gray-100 dark:border-gray-800 grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <RequirementItem 
            ...
            <div className="p-6 space-y-6 bg-white dark:bg-gray-900">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="flex-1 px-4 py-2.5 text-sm font-bold text-gray-600 dark:text-gray-300 hover:bg-gray-100 rounded-xl transition"
                >
                  Cancel
                </button>
                <button
...
function RequirementItem({ label, met }: { label: string, met: boolean }) {
  return (
    <div className={`flex items-center gap-2 text-[11px] font-medium transition-colors ${met ? 'text-green-600' : 'text-gray-400'}`}>
      {met ? <LuCheck className="w-3.5 h-3.5" /> : <div className="w-3.5 h-3.5 rounded-full border-2 border-gray-200 dark:border-gray-700" />}
      {label}
    </div>
  );
}
