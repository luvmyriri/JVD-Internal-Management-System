  ...
  return (
    <div className="flex items-center justify-between px-6 py-4 bg-white border-t border-gray-50">
      <div className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">
        Showing <span className="text-gray-900">{start}</span>–<span className="text-gray-900">{end}</span> of <span className="text-gray-900">{total}</span> Records
      </div>
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className="w-10 h-10 flex items-center justify-center rounded-xl border border-gray-100 text-gray-400 hover:bg-gray-50 disabled:opacity-30 disabled:hover:bg-transparent transition-all"
        >
